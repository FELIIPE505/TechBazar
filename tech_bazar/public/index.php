...
<body background="/imagens/hex2f3136.png">
    ...
    <header>
        ...
        <nav>
            <button onclick="window.location.href='index.html'">Loja</button>
            <button onclick="window.location.href='form_usuario.php'">Minha Biblioteca</button>
            <button onclick="window.location.href='form_usuario.php'">Categorias</button>
        </nav>
